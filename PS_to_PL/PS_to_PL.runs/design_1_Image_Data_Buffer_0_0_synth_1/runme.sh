...
HD_PWD='/home/akshat/Documents/Horus_VPU/Basics/PS_to_PL/PS_to_PL.runs/design_1_Image_Data_Buffer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Image_Data_Buffer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Image_Data_Buffer_0_0.tcl
